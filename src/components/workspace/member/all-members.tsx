        ...
        <div className="flex items-center gap-3">
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" size="sm" className="ml-auto min-w-24">
          ...
          <Button variant="destructive" size="sm" className="ml-auto min-w-24">
            Leave
          </Button>
        </div>
      </div>
      <div className="flex items-center justify-between space-x-4">
        <div className="flex items-center space-x-4">
          <Avatar className="h-8 w-8">
            ...
            <AvatarFallback className={`${getAvatarColor("JL")}`}>
              JL
            </AvatarFallback>
          </Avatar>
          <div>
      ...
      <div className="flex items-center justify-between space-x-4">
        <div className="flex items-center space-x-4">
          <Avatar className="h-8 w-8">
            ...
            <AvatarFallback className={`${getAvatarColor("IN")}`}>
              IN
            </AvatarFallback>
          </Avatar>
          <div>
